...
function btn1(){
	...
	function btn6(){
		...
		$.ajax(
			{
				type:"get",
				url:"scoreQueryResultSix.action",
  ...
  <jsp:include page="scoreServiceNavigation.jsp"></jsp:include>
    <div id="accordion">
    	...
    	<div align="left" class="frame">
    		...
    		<table class="datalist">
    		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;课程：<select name="courseID" id="courseID6">
    				<s:iterator value="courses">
    					<option value='<s:property value="bianHao"/>'><s:property value="name" /></option>
    				</s:iterator>&nbsp;&nbsp;&nbsp;<input type="button" name="btn6" value="预测-分析"  />
    		</table>
    		</form>
    		
    		<%-- <form action="scoreQueryResultSecond.action" method="post" id="myForm2">
    		<table class="datalist">
    			<tr><td>学号：<input type="text" name="stuXueHao" id="sxh2" /><select name="courseID" id="courseID2">
    				</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;课程：<select name="courseID" id="courseID2">
    				<s:iterator value="courses">
    					<option value='<s:property value="bianHao"/>'><s:property value="name" /></option>
    				</s:iterator>
    			</select>
    			&nbsp;&nbsp;&nbsp;<input type="button" name="btn2" value="查询-分析" /></td></tr>
    		</table>
    		</form> --%>
