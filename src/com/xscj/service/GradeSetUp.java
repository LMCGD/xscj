...
/**
 * @author wyf 班级设置业务逻辑处理接口
 *
 */
public interface GradeSetUp {
	/**
	 * @author wyf 得到班级总数的业务逻辑处理接口
	 * 
	 * */
	...
	/**
	 * 
	 * @author wyf 得到所有的班级列表的业务逻辑处理接口
	 * */
	public List<Grade> getAllGrades();
	
	/**
	 * @author wyf 得到高一年级所对应届的业务逻辑处理接口
	 * @date 2014-3-18 上午9:43:48
	 * */
	public int getMaxYear();
	
	/**
	 * @author wyf得到指定区间内班级个数的业务逻辑处理接口
	...
	/**
	 * @author wyf 向数据库中添加一条新的班级信息的业务逻辑处理接口
	...
	/**
	 * 
	 * @author wyf得到最新一届的班级列表的业务逻辑处理接口
