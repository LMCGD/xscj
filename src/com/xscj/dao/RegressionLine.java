...
{  
    ...
    /** 误差 */  
    private double sse;//残差平方和,除了线性关系对y的变化外，其他因素对y的变差的作用。  
  //对一个具体的观测值变差的大小
    private double sst;//总平方和  
   //sst=sse+ssr(回归平方和)，用SSR在SST中的占比来判断拟合的好坏
    private double E;  
  
    private String[] xy;  
  
    private ArrayList listX;//x的链表  
  
    private ArrayList listY;  ///y的链表
